export default class DragDrop {
  ...
  #onMouseUp(event) {
    ...
    if (target !== this.#draggingBox) return this.#removeDraggingBox();
  ...
  #removeDraggingBox() {
    ...
    // this.#draggingBox.style.transition = animDuration + "ms linear";
    // this.#draggingBox.style.top = window.scrollY + y2 + "px";
    // this.#draggingBox.style.left = window.scrollX + x2 + "px";
  ...
  #moveBox(direction) {
    ...
    this.onKeyDrag() === null ? this.onKeyDrag() : this.onDrag();
  }
